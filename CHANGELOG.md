...
- Summary of what was changed in a single line using past tense & followed by two whitespaces.  
  Issue: [#0](https://github.com/Flinesoft/AnyLint-Swift/issues/0) | PR: [#0](https://github.com/Flinesoft/AnyLint-Swift/pull/0) | Author: [Cihat Gündüz](https://github.com/Jeehut)
```
